...
\begin{figure}[p]
	\begin{center}
		\includegraphics[width=1.1\textwidth]{rmseonan_average_abcf_Denver.png}
	\end{center}
...
\begin{figure}[p]
	\begin{center}
		\includegraphics[width=1.1\textwidth]{rmseonan_arima_abcf_Denver.png}
	\end{center}
...
\begin{figure}[p]
	\begin{center}
		\includegraphics[width=1.1\textwidth]{rmseonan_svm_abcf_Denver.png}
	\end{center}
...
\begin{figure}[p]
	\begin{center}
		\includegraphics[width=1.1\textwidth]{rmseonan_TDNN_abcf_Denver.png}
	\end{center}
...
DISCUSS HOW NO MODEL GETS SIGNIFICANTLY WORSE - MOST GAIN A SLIGHT IMPROVEMENT. 
