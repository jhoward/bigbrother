...
results.tdnn.rmse = rmsehist;
results.tdnn.mase = masehist;
results.tdnn.rmseonan = rmseonanhist;
results.tdnn.sqeonan = sqeonanhist;
results.tdnn.sqeonan3 = sqeonan3hist;
results.tdnn.trainForecast = trainForecasts;
results.tdnn.validForecast = validForecasts;
results.tdnn.testForecast = testForecasts;
