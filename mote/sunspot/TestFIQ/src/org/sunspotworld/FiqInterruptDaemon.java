...
import com.sun.spot.peripheral.IFiqInterruptDaemon;
import com.sun.spot.peripheral.IPowerController;
import com.sun.spot.peripheral.ISpotPins;
...
//		Utils.log("[SpotLib] Handled power controller status of 0x" + Integer.toHexString(status));
    ...
    public void setExitOnButtonPress(boolean bln) {
    }

    public void addAlarmHandler(IEventHandler ieh) {
    }

    public void removeAlarmHandler(IEventHandler ieh) {
    }

    public void addButtonHandler(IEventHandler ieh) {
    }

    public void removeButtonHandler(IEventHandler ieh) {
    }

    public void addPowerOffHandler(IEventHandler ieh) {
    }

    public void removePowerOffHandler(IEventHandler ieh) {
    }

    public void addLowBatteryHandler(IEventHandler ieh) {
    }

    public void removeLowBatteryHandler(IEventHandler ieh) {
    }

    public void addExternalPowerHandler(IEventHandler ieh) {
    }

    public void removeExternalPowerHandler(IEventHandler ieh) {
    }

    public void addSensorBoardHandler(IEventHandler ieh) {
    }

    public void removeSensorBoardHandler(IEventHandler ieh) {
    }

    public IEventHandler setSensorBoardHandler(IEventHandler ieh) {
        return null;
    }
